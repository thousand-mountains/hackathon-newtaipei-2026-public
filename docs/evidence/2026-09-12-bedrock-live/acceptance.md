...
| AC8b from_node 無 base → 400 | ❌ | HTTP 202：{"run_id": "run-synthetic-ordinary-01-2ef241ab16fc", "status": "running", "result_url": "/api/runs/run-synthetic-ordinary-01-2ef241ab16fc", "events_url": "/api/runs/run-synthetic-ordinary-01-2ef241ab16fc/events"} |
