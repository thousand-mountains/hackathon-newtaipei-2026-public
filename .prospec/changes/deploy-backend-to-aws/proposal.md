...
| 帳號回收 | 最晚 2026-09-15 08:00 | **不投資難拆的架構**；不引入 CDK／IaC |
...
- 已知限制：**大會帳號最晚 9/15 08:00 收回，屆時網址失效**。若賽方要求賽後仍可存取，需另議帳號——**這題超出本 change 範圍，需 Ci 拍板**
...
2. **賽後網址是否需存活。** 大會帳號 9/15 08:00 收回。需 Ci 拍板。
